...
<?php include 'header.php'; ?>
        ...
        <table class="table table-bordered" id="datatable-buttons">
             ...
             $sql = 'SELECT servicio, destino,numero_envio,destinatario,fecha_entrada,DATEDIFF(sysdate(),fecha_entrada) AS Tiempo,ems_carteros FROM customers
             WHERE destino = "CENTRO DE LOS HEROES"  AND servicio = "EMS" and ems_carteros <> "Seleccionar Cartero" ORDER BY tiempo DESC;';
       ...
       0 => '#00C13F',   
        ...
        45 => '#ff6666'  
                  ...
                  echo '<td style="color: #000;">'. $row['ems_carteros'] . '</td>';
                  echo '</tr>';
             }
             Database::disconnect();
            ?>
