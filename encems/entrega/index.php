...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="#" title='Programming Blog'>INSTITUTO POSTAL DOMINICANO | EMS | Liquidar Piezas a Entregar</a>
        </div>
...
<?php
  $res = $MySQLiconn->query("SELECT id,numero_envio,servicio,fecha_entrada,presinto_servicio,colectora,peso_real,destino,destinatario,telefono,ems_carteros
                       from customers WHERE destino = 'CENTRO DE LOS HEROES' AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') <> DATE_FORMAT(SYSDATE(),'%Y/%m/%d') AND  ems_carteros IS NOT NULL AND ems_carteros <> 'Seleccionar cartero...'  and servicio = 'EMS' ORDER BY id DESC");
  $count = $res->num_rows;
...
<td><?php echo $row["ems_carteros"]; ?></td>
