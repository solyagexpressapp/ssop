...
<html lang="en">
  <head>
    ...
    <title>INSTITUTO POSTAL DOMINICANO! | Tiempo de Entrega Bulto Postal</title>
...
<?php include 'header.php'; ?>
        ...
        <table class="table table-bordered" id="datatable-buttons">
             ...
             $sql = 'SELECT servicio, destino,numero_envio,destinatario,fecha_entrada,DATEDIFF(SYSDATE(),fecha_entrada) AS Tiempo FROM customers
             where destino = "JARDINES METROPOLITANOS" AND servicio = "BULTO POSTAL"  order by tiempo desc;';
