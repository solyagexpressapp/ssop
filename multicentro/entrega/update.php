<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "UPDATE customers  set colectora = ?,despacho_general = ? WHERE destino='PUERTO PLATA' id = ?";
			$q = $pdo->prepare($sql);
					...
					<!--Comienzo-->
					  ...
					  <!--numero10-->
					   <div class="control-group <?php echo !empty($colectoraError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="colectora" type="text" disabled placeholder="presinto colector" value="<?php echo !empty($colectora)?$colectora:'';?>">
					  ...
					  <div class="control-group <?php echo !empty($despacho_generalError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="despacho_general" type="text" disabled placeholder="numero de despacho general" value="<?php echo !empty($despacho_general)?$despacho_general:'';?>">
