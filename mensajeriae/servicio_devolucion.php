...
<html lang="en">
  <head>
    ...
    <title>Devoluciones! | MENSAJERIA</title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered">
             ...
             $sql = "SELECT * from  customers WHERE porque IS NOT NULL AND  status= 1 AND servicio='MENSAJERIA' and condicion_general = 1  ORDER BY id DESC";
