...
<html lang="en">
  <head>
    ...
    <title>INSTITUTO POSTAL DOMINICANO! | OPERACIONES</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="glyphicon glyphicon-send"></i><span>OPERACIONES!</span></a>
            </div>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTIN DE <?php echo $destino1; ?><small></small></h2>
...
<?php
$sql = "SELECT id_estafeta,destino FROM estafeta GROUP BY destino";
...
<br>
<br>
Seleccionar Servicio : <select name="servicio">
  <option value="BULTO POSTAL">Bulto Postal</option>
  <option value="CERTIFICADO">Certificado</option>
  <option value="COLIS POSTAL">Colis Postal</option>
  <option value="EMS">EMS</option>
</select>
<br/>
<br/>
Seleccionar la Fecha: <input type="date" name="fecha"  onChange="this.form.submit()">
</form>
...
FROM
    ...
    INNER JOIN narisol_bladi.division_regional 
       ...
       WHERE CONDICION_GENERAL = 1 AND customers.destino = '$destino1' AND fecha_entrada = '$fecha' AND servicio = '$servicio'
...
<form action="update.php" method="post">
  ...
  <br/>Accion : <select name="calidad">
  <option value="0">Almacenar</option>
  <option value="1">Despachar</option>
</select>
<br/>
<br/> 
<input type="submit" class="btn btn-primary" value="Correcto">
</form>
<!--<a class="btn btn-primary" href="listing.php?destino1='.$row['destino'].'&fecha='.$row['fecha_entrada'].'">Correcto</a>-->
