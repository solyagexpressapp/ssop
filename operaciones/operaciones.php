...
<html lang="en">
  <head>
    ...
    <title>INSTITUTO POSTAL DOMINICANO! | Direccion de Operaciones</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="glyphicon glyphicon-send"></i><span>Direccion de Operaciones!</span></a>
            </div>
            ...
            <div class="profile">
              ...
              <div class="profile_info">
                ...
                <h2>Direccion de Operaciones</h2>
              </div>
            </div>
            <br />
            <!-- sidebar menu -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">Direccion de Operaciones
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Unificar Despacho de día <?php echo $fecha1; ?><small></small></h2>
...
Seleccionar Ruta:<select name="destino1" >
<option>Seleccionar...</option>
<option value="1">LISTING</option>
<option value="2">POSTAL INTERIOR</option>
<option value="3">POSTAL LOCAL</option>
</select>
<br/>
<br/>
Seleccionar la Fecha que Desea Unificar con la Actual: <input type="date" name="fecha"  onChange="this.form.submit()">
</form>
...
FROM
    ...
    INNER JOIN narisol_bladi.division_regional 
       ...
       WHERE CONDICION_GENERAL = 1 AND estafeta.listin = '$destino1' AND fecha_entrada = '$fecha' 
       GROUP BY destino,presinto_servicio,servicio
ORDER BY destino,servicio";
...
<form action="unificar.php" method="post">
