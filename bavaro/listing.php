...
WHERE DATE_FORMAT(fecha_entrada,'%Y/%m/%d') <> DATE_FORMAT(SYSDATE(),'%Y/%m/%d') AND fecha_entrada = '$fecha2' AND destino = 'BAVARO' ";
...
echo("<meta http-equiv=\"refresh\" content=\"0; url=bavaro.php\"/>");
