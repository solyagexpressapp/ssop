...
WHERE DATE_FORMAT(fecha_entrada,'%Y/%m/%d') <> DATE_FORMAT(SYSDATE(),'%Y/%m/%d') AND fecha_entrada = '$fecha2' AND destino = 'GUERRA' ";
...
echo("<meta http-equiv=\"refresh\" content=\"0; url=guerra.php\"/>");
