<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "INSERT INTO customers (servicio,destino,destinatario,direccion,peso_real,descripcion,presinto_servicio,despacho_servicio,destino2) values(?,?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array('TRANSITO',$destino,$destinatario,$direccion,$peso_real,$descripcion,$presinto_servicio,$despacho_servicio,$destino2));
			Database::disconnect();
...
<body>
    <div class="container">
    		...
    		<form class="form-horizontal" action="create.php" method="post">
					    ...
					    <div class="controls">
					      	<input name="servicio" type="text"  placeholder="fecha de entrada" value="TRANSITO" disabled>
                     ...
                     <!--Octavo-->
					  ...
					  <div class="form-actions">
						  ...
						  <a class="btn" href="../transito.php">Atras</a>
						</div>
					</form>
