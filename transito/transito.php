    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="glyphicon glyphicon-send"></i> <span>TRANSITO!</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">TRANSITO
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registro de Transitos <small></small></h2>
        ...
        <table class="table table-striped table-bordered">
             ...
             $sql = 'SELECT * FROM customers WHERE transito = "TRANSITO" AND confirmacion = 1 ORDER BY id DESC';
             foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-primary" href="transito/read.php?id='.$row['id'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="transito/delete.php?id='.$row['id'].'">Correcto</a>';
                  echo '&nbsp;';
                  echo '</td>';
                  echo '</tr>';
             }
