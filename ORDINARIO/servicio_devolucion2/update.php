...
$sql = "UPDATE customers  set presinto_servicio = ?,destino = ?, despacho_servicio = ?, porque= ?, motivo = ? , condicion_general = 1,monitores = ?,oficiales = ?,fecha_entrada = SYSDATE()  WHERE id = ?";
			$q = $pdo->prepare($sql);
