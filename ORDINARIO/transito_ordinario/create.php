<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "INSERT INTO customers (servicio,destino,destinatario,direccion,descripcion,presinto_servicio,despacho_servicio,destino2,transito) values(?,?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array('ORDINARIO',$destino,$destinatario,$direccion,$descripcion,$presinto_servicio,$despacho_servicio,$destino2,'TRANSITO'));
			Database::disconnect();
...
<body>
    <div class="container">
    		...
    		<form class="form-horizontal" action="create.php" method="post">
					    ...
					    <div class="controls">
					      	<input name="servicio" type="text"  placeholder="servicio" value="ORDINARIO" disabled>
