    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-bordered">
             ...
             $sql ="SELECT id,servicio,presinto_servicio,colectora,peso_real,destino,destinatario,telefono,fecha_entrada,SYSDATE() AS Dia, DATEDIFF(SYSDATE(),fecha_entrada) AS Tiempo FROM customers WHERE servicio = 'ORDINARIO' ORDER BY tiempo DESC";
        ...
        48 => '#FF2E12',
                  ...
                  echo '&nbsp;';
                  /*echo '<a class="btn btn-danger" href="ordinario/delete.php?id='.$row['id'].'">Eliminar</a>';*/
                  echo '</td>';
                  echo '</tr>';
             }
             Database::disconnect();
