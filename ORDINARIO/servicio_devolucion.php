...
<html lang="en">
  <head>
    ...
    <title>Devoluciones! | Bulto Postal</title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered">
             ...
             $sql = "SELECT * from  customers WHERE porque IS NOT NULL AND  status= 1 AND servicio='BULTO POSTAL' and condicion_general = 1  ORDER BY id DESC";
