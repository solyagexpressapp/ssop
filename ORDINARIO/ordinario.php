...
<html lang="en">
  <head>
    ...
    <title>Servicio! | ORDINARIO</title>
...
<?php include 'header.php'; ?>
        ...
        <p>
          <a href="ordinario/create.php" class="btn btn-success">Crear Despacho</a>
        </p>
        ...
        <table id="datatable-buttons" class="table table-bordered" >
             ...
             $sql = "SELECT id,servicio,presinto_servicio,colectora,peso_real,destino,destinatario,telefono,fecha_entrada,SYSDATE() AS Dia, DATEDIFF(SYSDATE(),fecha_entrada) AS Tiempo FROM customers WHERE servicio = 'ORDINARIO'  AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d') ORDER BY id DESC";
             foreach ($pdo->query($sql) as $row) { array(   
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-primary" href="ordinario/read.php?id='.$row['id'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="ordinario/update.php?id='.$row['id'].'">Editar</a>';
                  echo '&nbsp;';
