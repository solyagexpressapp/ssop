...
<form name="form1" >
 <?php $fecha1 = date('Y-m-d'); ?>
    <center> <h1> Reporte detallado de Enviadas </h1> </center>
<?php 
//QUERY COMBO 2
    ...
    <title>Reporte detallado de Entregas</title>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
           ...
           <table class="table table-bordered">
             ...
             $sql = "SELECT DISTINCT(numero_envio) AS tracking,servicio, destino,destinatario,fecha_entrada,presinto_servicio,colectora
FROM devolucion
WHERE destino = '$ser5[1]' and fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' AND servicio = 'COLIS POSTAL' ";
