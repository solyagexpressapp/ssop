...
<form name="form1" >
 <?php $fecha1 = date('Y-m-d'); ?>
    <center> <h1> Reporte detallado de mal encaminados </h1> </center>
<?php 
//QUERY COMBO 2
...
<html>
    <head>
    <title>Reporte detallado de mal encaminados</title>
    <style type="text/css">
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
           ...
           <table class="one" border="1">
             ...
             $sql = "SELECT DISTINCT(numero_envio),servicio,destino ,destinatario,fecha_entrada
FROM devolucion
