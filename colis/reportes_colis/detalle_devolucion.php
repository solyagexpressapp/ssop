...
<form name="form1" >
 <?php $fecha1 = date('Y-m-d'); ?>
    <center> <h1> Reporte detallado de Devoluciones </h1> </center>
<?php 
//QUERY COMBO 2
...
<html>
    <head>
    <title>Reporte detallado de Devoluciones</title>
    <style type="text/css">
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
           ...
           <table class="one" border="1">
             ...
             $sql = "SELECT DISTINCT(numero_envio) AS tracking,servicio, destino,destinatario,fecha_entrada,fecha_entrega,DATEDIFF(fecha_entrada,fecha_entrega) AS Tiempo 
FROM devolucion
WHERE servicio = 'COLIS POSTAL' AND motivo = 'DEVOLUCION' AND destino = '$ser5[1]' and fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' ";
