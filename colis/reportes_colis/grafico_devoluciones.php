...
<html>
    <head>
        ...
        <title>REPORTE DE DEVOLUCIONES POR OFICINA</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'REPORTE DE DEVOLUCIONES POR OFICINA'
        },
        subtitle: {
            text: ''
        },
        ...
        yAxis: {
            min: 0,
            title: {
                text: 'Rango de Piezas DEVOLUCIONES'
            }
        },
        legend: {
            enabled: false
        ...
        tooltip: {
            pointFormat: 'Piezas DEVOLUCIONES: <b>{point.y:.0f} Piezas</b>'
        },
        series: [{
            name: 'Piezas',
            data: [
               <?php
            $sql=mysql_query(" SELECT servicio,COUNT(cantidad) AS cantidad
FROM devolucion
