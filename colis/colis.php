  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <p>
          <a href="colis/create.php" class="btn btn-success">Crear Despacho</a>
        </p>
        ...
        <table  id="datatable-buttons" class="table table-striped table-bordered ">
             ...
             $sql  ="SELECT id,servicio,presinto_servicio,colectora,peso_real,destino,destinatario,telefono,fecha_entrada,numero_envio,SYSDATE() 
             AS Dia, DATEDIFF(SYSDATE(),fecha_entrada) AS Tiempo, numero_turno FROM customers WHERE servicio = 'COLIS POSTAL' AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d') ORDER BY destino DESC";
             foreach ($pdo->query($sql) as $row) { 
                  ...
                  echo '<td style="color: #000;">'. $row['numero_turno'] . '</td>';
