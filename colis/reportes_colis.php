    ...
    <div class="container body">
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered" id="datatable-buttons">
             ...
             $sql = "SELECT * FROM customers WHERE servicio = 'COLIS POSTAL'   ORDER BY id DESC";
             foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-primary" href="colis/read.php?id='.$row['id'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="colis/update.php?id='.$row['id'].'">Editar</a>';
                  echo '&nbsp;';
                  /*echo '<a class="btn btn-danger" href="colis/delete.php?id='.$row['id'].'">Eliminar</a>';*/
                  echo '</td>';
                  echo '</tr>';
             }
             Database::disconnect();
