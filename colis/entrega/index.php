...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="#" title='Programming Blog'>INSTITUTO POSTAL DOMINICANO | COLIS POSTAL | Liquidar Piezas a Entregar</a>
        </div>
...
<?php
	$res = $MySQLiconn->query("SELECT id,numero_envio,servicio,fecha_entrada,presinto_servicio,colectora,peso_real,destino,destinatario,telefono
                       FROM customers WHERE DATE_FORMAT(fecha_entrada,'%Y/%m/%d') <> DATE_FORMAT(SYSDATE(),'%Y/%m/%d') AND servicio  IN ('COLIS POSTAL','BULTO POSTAL') and destino  = 'CENTRO DE LOS HEROES' ORDER BY id DESC");
	$count = $res->num_rows;
