          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Reportes para impresion del Dia<small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
                      ...
                      <?php 
                       ...
                       $sql = "SELECT * FROM customers WHERE servicio = 'COLIS POSTAL' AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d')";
