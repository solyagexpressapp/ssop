...
WHERE servicio = 'COLIS POSTAL' AND impresion = 1 AND fecha_entrada = '$fecha' AND (customers.destino LIKE '%$destino1%')
...
function redireccionarPagina() {
  window.location = "../update_recibo.php";
}
