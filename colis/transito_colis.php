...
<?php include 'header.php'; ?>
        ...
        <p>
          <a href="transito_colis/create.php" class="btn btn-success">Crear Transito</a>
        </p>
       ...
       <table class="table table-striped table-bordered">
             ...
             $sql = 'SELECT * FROM customers WHERE servicio = "COLIS POSTAL" AND transito = "TRANSITO" ORDER BY id DESC';
             foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-primary" href="transito_colis/read.php?id='.$row['id'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="transito_colis/update.php?id='.$row['id'].'">Editar</a>';
                  echo '&nbsp;';
                  echo '</td>';
                  echo '</tr>';
             }
