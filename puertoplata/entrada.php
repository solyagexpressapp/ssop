...
include 'conexion.php';
	...
	$log = mysql_query("SELECT * FROM contabilidad WHERE nombre='$usuario' AND pass='$pw' AND servicio='PUERTO PLATA' ");
				if (mysql_num_rows($log)>0) {
					...
					echo '<script> window.location="puerto_plata.php"; </script>';
				}
				else{
