...
WHERE destino IN ('PUERTO PLATA','AEROPUERTO LUPERON','AG-LUPERON','EL ESTRECHO','ESTERO HONDO','GUALETE','GUANANICO','LA ISABELA','MONTELLANOS','YASICA ARRIBA')
...
header("Location:puerto_plata.php");
?>