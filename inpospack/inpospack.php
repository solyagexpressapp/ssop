...
<html lang="en">
  <head>
    ...
    <title>Servicio! | InposPack</title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="glyphicon glyphicon-send"></i> <span>INPOSPACK!</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">INPOSPACK
        ...
        <p>
          <a href="inpospack/create.php" class="btn btn-success">Crear Despacho</a>
        </p>
        ...
        <table class="table table-bordered">
             ...
             $sql = "SELECT id,servicio,presinto_servicio,colectora,peso_real,destino,destinatario,telefono,fecha_entrada,SYSDATE() AS Dia, DATEDIFF(SYSDATE(),fecha_entrada) AS Tiempo FROM customers WHERE servicio = 'INPOSPACK' ORDER BY tiempo DESC";
        ...
        16 => '#FF2E12'      
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-primary" href="inpospack/read.php?id='.$row['id'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="inpospack/update.php?id='.$row['id'].'">Editar</a>';
                  echo '&nbsp;';
                  /*echo '<a class="btn btn-danger" href="inpospack/delete.php?id='.$row['id'].'">Eliminar</a>';*/
                  echo '</td>';
                  echo '</tr>';
             }
             Database::disconnect();
