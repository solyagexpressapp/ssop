<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$q = $pdo->prepare($sql);
			$q->execute(array('INPOSPACK',$numero_envio,$destino,$destinatario,$direccion,$peso_real,$telefono,$descripcion,$presinto_servicio,$despacho_servicio));
			Database::disconnect();
...
<body>
    <div class="container">
    		...
    		<form class="form-horizontal" action="create.php" method="post">
					    ...
					    <div class="controls">
					      	<input name="servicio" type="text"  placeholder="inpospack" value="INPOSPACK" disabled>
