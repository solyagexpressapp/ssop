...
<html lang="en">
  <head>
    ...
    <title>INSTITUTO POSTAL DOMINICANO! | SALCEDO</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="glyphicon glyphicon-send"></i><span>SALCEDO</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">SALCEDO
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTIN DE SALCEDO DEL DIA <?php echo $fecha; ?> <small></small></h2>
...
FROM
    ...
    INNER JOIN narisol_bladi.division_regional 
       ...
       WHERE CONDICION_GENERAL = 1 AND customers.destino = 'SALCEDO' AND fecha_entrada = '$fecha' AND alerta IS NULL
