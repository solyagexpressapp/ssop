...
<html lang="en">
  <head>
    ...
    <title>Servicio! | Bulto Postal</title>
...
<?php include 'header.php'; ?>
        ...
        <table id="datatable-buttons" class="table table-bordered" >
             ...
             $sql = "SELECT id,servicio,presinto_servicio,colectora,peso_real,destino,destinatario,telefono,fecha_entrada,SYSDATE() AS Dia, DATEDIFF(SYSDATE(),fecha_entrada) AS Tiempo FROM customers WHERE servicio = 'BULTO POSTAL'  AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d') ORDER BY id DESC";
             foreach ($pdo->query($sql) as $row) { array(   
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-primary" href="bulto/read.php?id='.$row['id'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="bulto/update.php?id='.$row['id'].'">Editar</a>';
                  echo '&nbsp;';
