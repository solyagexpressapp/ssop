...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
               <?php
            $sql=mysql_query(" SELECT servicio,COUNT(DISTINCT(id)) AS cantidad
FROM devolucion
WHERE servicio = 'BULTO POSTAL' AND motivo = 'MAL ENCAMINADO' AND fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "'       
     GROUP BY servicio;
