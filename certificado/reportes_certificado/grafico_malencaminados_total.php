...
<html>
    <head>
        ...
        <title>REPORTE DE TOTAL DE MAL ENCAMINADOS</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'REPORTE DE TOTAL DE MAL ENCAMINADOS '
        },
        subtitle: {
            text: ''
        },
...
FROM devolucion
WHERE servicio = 'CERTIFICADO' AND motivo = 'MAL ENCAMINADO' AND fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "'       
     GROUP BY servicio;
