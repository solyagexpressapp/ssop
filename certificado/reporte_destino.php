...
<html lang="en">
  <head>
    ...
    <title>INSTITUTO POSTAL DOMINICANO! | CERTIFICADO</title>
...
<br/> 
<p>NOTA: Cuando se valla a seleccionar un monitor primero tendran que elegir <strong>CENTRO DE LOS HEROES</strong></p> <br/>
<hr>
<br/>
<h5>Esta area es para imprimirlo todo sin necesidad de elegir las provincias</h5>
<br/>
 <form action="golber.php?fecha='<?php echo $fecha ;?>'" target="_blank">
<?php $fecha_actual = date("Y-m-d"); ?>
Seleccionar la Fecha: <input type="date" value="<?php echo $fecha_actual ?>" name="fecha">
<br/>
<br/>
