  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <button class="btn btn-success"><a href="imprimir_acuse_sede.php?numero_envio='<?php echo $row['numero_envio']?>'">Imprimir</a></button>
        <br/>
...
FROM narisol_bladi.customers
    ...
    INNER JOIN narisol_bladi.division_regional 
        ...
        WHERE  servicio = 'CERTIFICADO' AND estafeta.destino = 'CENTRO DE LOS HEROES'   AND motivo is null  AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d')
 ORDER BY id desc";
