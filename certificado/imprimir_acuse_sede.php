...
$result = mysql_query("SELECT presinto_servicio,despacho_servicio,numero_envio,peso_real, estafeta.destino AS destino,fecha_entrada,pais_origen,destinatario,oficiales,monitores
...
function redireccionarPagina() {
  window.location = "update_acuse_sede.php";
}
