<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$q = $pdo->prepare($sql);
			$q->execute(array('CERTIFICADO',$numero_envio,$destino,$destinatario,$direccion,$peso_real,$telefono,$descripcion,$despacho_servicio,$impresion,$monitores,$oficiales,$id));
			Database::disconnect();
			header("Location: ../certificado.php");
		}
	} else {
