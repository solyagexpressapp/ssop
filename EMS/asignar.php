...
<form action="update_despacho.php?destino1='<?php echo $destino ;?>'&despacho='<?php echo $despacho ;?>'&precinto='<?php echo $precinto ;?>' ">
  <?php
...
<br/>
<br/>
Numero de Precinto: <input name="precinto" type="text">
<br/>
<br/>
