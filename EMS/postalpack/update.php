<?php 
	...
	if ( null==$id ) {
		header("Location: ../postalpack.php");
	}
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$q = $pdo->prepare($sql);
			$q->execute(array('POSTAL PACK',$numero_envio,$destino,$destinatario,$direccion,$peso_real,$telefono,$descripcion,$presinto_servicio,$despacho_servicio,$id));
			Database::disconnect();
			header("Location: ../postalpack.php");
		}
	} else {
    ...
    <div class="container">
    			...
    			<div class="span10 offset1">
					...
					<!--Comienzo-->
					    ...
					    <div class="controls">
					      	<input name="servicio" type="text"  placeholder="fecha de entrada" disabled value="POSTAL PACK">
					  ...
					  <div class="form-actions">
						  ...
						  <a class="btn" href="../postalpack.php">Atras</a>
						</div>
					</form>
				</div>
