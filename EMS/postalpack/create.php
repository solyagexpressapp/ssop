<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "INSERT INTO customers (servicio,numero_envio,destino,destinatario,direccion,peso_real,telefono,descripcion,presinto_servicio,despacho_servicio) values(?,?,?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array('POSTAL PACK',$numero_envio,$destino,$destinatario,$direccion,$peso_real,$telefono,$descripcion,$presinto_servicio,$despacho_servicio));
			Database::disconnect();
...
<body>
    <div class="container">
    		...
    		<form class="form-horizontal" action="create.php" method="post">
					    ...
					    <div class="controls">
					      	<input name="servicio" type="text"  placeholder="fecha de entrada" value="POSTAL PACK" disabled>
