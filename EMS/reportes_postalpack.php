    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Reporte de Postal Pack distribuidos diario <small></small></h2>
        ...
        <table class="table table-striped table-bordered" id="datatable-buttons">
             ...
             $sql = 'SELECT * FROM customers WHERE servicio = "Postal Pack" ORDER BY id DESC';
             foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '&nbsp;';
                  /*echo '<a class="btn btn-danger" href="ems/delete.php?id='.$row['id'].'">Eliminar</a>';*/
                  echo '</td>';
                  echo '</tr>';
             }
             Database::disconnect();
