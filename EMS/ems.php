...
<html lang="en">
  <head>
    ...
    <title>INSTITUTO POSRAL DOMINICANO! | EMS</title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <p>
          <a href="ems/create.php" class="btn btn-success">Crear Despacho</a>
        </p>
...
FROM customers WHERE servicio = 'EMS' AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d')
ORDER BY Destino ASC;";
             foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-primary" href="ems/read.php?id='.$row['id'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="ems/update.php?id='.$row['id'].'">Editar</a>';
                  echo '&nbsp;';
