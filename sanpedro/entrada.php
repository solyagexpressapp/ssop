...
include 'conexion.php';
	...
	$log = mysql_query("SELECT * FROM contabilidad WHERE nombre='$usuario' AND pass='$pw' AND servicio='SAN PEDRO DE MACORIS' ");
				if (mysql_num_rows($log)>0) {
					...
					echo '<script> window.location="sanpedro.php"; </script>';
				}
				else{
