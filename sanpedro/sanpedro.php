...
<html lang="en">
  <head>
    ...
    <title>INSTITUTO POSTAL DOMINICANO! | SAN PEDRO DE MACORIS</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="glyphicon glyphicon-send"></i><span>SAN PEDRO DE MACORIS</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">SAN PEDRO DE MACORIS
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTIN DE SAN PEDRO DE MACORIS DEL DIA <?php echo $fecha; ?> <small></small></h2>
...
FROM
    ...
    INNER JOIN narisol_bladi.division_regional 
       ...
       WHERE CONDICION_GENERAL = 1 AND customers.destino = 'SAN PEDRO DE MACORIS' AND fecha_entrada = '$fecha' AND alerta IS NULL
...
echo '<td width=250>';
echo '<a class="btn btn-danger" href="ips/update.php?presinto_servicio='.$row['presinto_servicio'].'&destino1='.$row['destino'].'
&fecha='.$row['fecha_entrada'].'">Eliminar</a>';
echo '</td>';
echo '</tr>';
...
<form action="listing.php" method="post">
  ...
  <br/>Control de Calidad : <select name="calidad">
