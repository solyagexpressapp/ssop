...
<html lang="en">
  <head>
    ...
    <title>Servicio! | Tiempo de Entrega Colis Postal</title>
...
<?php include 'header.php'; ?>
        ...
        <table class="table table-bordered" id="datatable-buttons">
             ...
             $sql = 'SELECT servicio, destino,numero_envio,destinatario,fecha_entrada,DATEDIFF(sysdate(),fecha_entrada) AS Tiempo,DATEDIFF(SYSDATE(),fecha_entrada) AS Tiempo,DATEDIFF(SYSDATE(),fecha_entrega) AS tiempo_oficina ,DATEDIFF(fecha_entrega,fecha_entrada) AS tiempo_sede,presinto_servicio 
             FROM customers
             where servicio = "COLIS POSTAL" and condicion_general <> 4 AND YEAR(fecha_entrada) >= "2019"
