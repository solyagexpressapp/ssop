...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
               <?php
            $sql=mysql_query(" SELECT servicio, COUNT(DISTINCT(presinto_servicio))
FROM devolucion 
WHERE servicio = 'JCE' AND destino = '$ser5[1]' AND fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "'       
     GROUP BY servicio;
