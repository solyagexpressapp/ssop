...
<html>
	<head>
		...
		<title>Reporte de Calidad de despacho</title>
...
$(function () {
    $('#container').highcharts({
        ...
        yAxis: {
            min: 0,
            title: {
                text: 'Rango de Calidad de Despacho'
            }
        },
        legend: {
            enabled: false
        ...
        tooltip: {
            pointFormat: 'Calidad de despacho: <b>{point.y:.0f} Piezas</b>'
        },
        series: [{
            name: 'Piezas',
            data: [
               <?php
            $sql=mysql_query("  SELECT calidad,COUNT(DISTINCT(colectora)) AS cantidad_calidad
FROM customers
