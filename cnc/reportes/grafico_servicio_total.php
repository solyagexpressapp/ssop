...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
               <?php
            $sql=mysql_query(" SELECT 'Total', COUNT(DISTINCT(numero_envio))
FROM devolucion 
WHERE  servicio IN ('CERTIFICADO','BULTO POSTAL','EMS','COLIS POSTAL') AND destino = '$ser5[1]' AND fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' ;
