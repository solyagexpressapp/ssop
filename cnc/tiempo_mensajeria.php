...
<html lang="en">
  <head>
    ...
    <title>Servicio! | Tiempo de Entrega Mensajeria</title>
...
<?php include 'header.php'; ?>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Seguimiento de Paquete del Mensajeria <small></small></h2>
        ...
        <table class="table table-bordered" id="datatable-buttons">
             ...
             where servicio = "MENSAJERIA" AND intentos <> 10  order by tiempo desc;';
