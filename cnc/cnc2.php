...
$result = mysql_query("SELECT id,servicio,presinto_servicio,despacho_general,COUNT(cantidad) AS cantidad
...
<form name="frmUser" method="post" action="delete_user.php">
<?php
$fecha = date('Y-m-d');
...
?>
<p>Debe de Seleccionar la fecha (obligatoriamente)</p><input type="date" name="fecha" required onchange="this.form.submit()" value="<?php echo $nuevafecha ?>"
 >
...
<td><input class="jean_amin" type="checkbox" name="users[]" value="<?php echo $row["destino"]; ?>" ></td>
...
?>
<tr class="listheader">
<td><!--<input type="button" name="delete" value="Correcto"  onClick="setDeleteAction();" />-->
<input type="submit" name="enviar" value="Correcto" />
</td>
</tr>
