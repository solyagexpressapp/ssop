...
<form name="form1" >
 <?php $fecha1 = date('Y-m-d'); ?>
    <center> <h1> Reporte detallado de Promedios de Entrega </h1> </center>
<?php 
//QUERY COMBO 2
...
page-break-after: always; 
    ...
    <title>Reporte detallado de Promedios de Entrega</title>
...
WHERE servicio IN ('CERTIFICADO','COLIS POSTAL','EMS','BULTO POSTAL') AND condicion_general = 3 AND destino = '$ser5[1]' AND fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "'
GROUP BY servicio";
