...
<?php include 'header.php'; ?>
       ...
       <table class="table table-striped table-bordered">
             ...
             $sql = 'SELECT * FROM customers WHERE servicio = "MENSAJERIA EXPRESA" AND transito = "TRANSITO" ORDER BY id DESC';
             foreach ($pdo->query($sql) as $row) {
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-primary" href="transito_MENSAJERIA EXPRESA/read.php?id='.$row['id'].'">Ver</a>';
                  echo '&nbsp;';
                  echo '<a class="btn btn-success" href="transito_MENSAJERIA EXPRESA/update.php?id='.$row['id'].'">Editar</a>';
                  echo '&nbsp;';
                  echo '</td>';
                  echo '</tr>';
             }
