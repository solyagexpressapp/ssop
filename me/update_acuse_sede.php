...
$sql="UPDATE customers set impresion = 2 WHERE  servicio = 'MENSAJERIA EXPRESA' AND destino = 'CENTRO DE LOS HEROES' ";
...
echo("<meta http-equiv=\"refresh\" content=\"0; url=acuse_sede.php\"/>");
