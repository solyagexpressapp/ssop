...
$result = mysql_query("SELECT upper(destinatario) as destinatario,no_recibo,upper(customers.direccion) AS direccion, customers.telefono, servicio, fecha_entrada,estafeta.destino AS destino,estafeta.direccion AS direccion_estafeta,cantidad,peso_real,numero_envio,estafeta.telefono AS oftel,
...
{
      $textoLimpio = preg_replace('([^A-Za-z0-9])', '', $data);	     					
      return $textoLimpio;
}
...
echo "<div class='cliente'>";
	echo "<table class='table'>";
		...
		echo "<tr>";
			...
			echo "<td><strong>".$data['destino']."</strong></td>";
		echo "</tr>";
