...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Acuse de Recibos Ciudad <small></small></h2>
        ...
        <button><a href="imprimir_acuse_ciudad.php?numero_envio='<?php echo $row['numero_envio']?>'">Imprimir</a></button>
        <br/>
  ...
  $sql = "SELECT presinto_servicio,despacho_servicio,numero_envio,peso_real, estafeta.destino AS destino,fecha_entrada,pais_origen,destinatario
FROM narisol_bladi.customers
    ...
    INNER JOIN narisol_bladi.division_regional 
        ...
        WHERE  servicio = 'MENSAJERIA EXPRESA' AND division_regional.nombre = 'CIUDAD'  AND customers.destino <> 'CENTRO DE LOS HEROES' AND impresion = 1 AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d')
 ORDER BY destino";
