          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Piezas entregadas<small></small></h2>
...
<table class="table table-striped table-bordered" id="datatable-buttons">
             ...
             $sql = 'SELECT servicio,cartero,destino,numero_envio,destinatario,destino,fecha_entrada,DATEDIFF(sysdate(),fecha_entrada) AS Tiempo FROM despachado WHERE cartero IS NOT NULL ';
