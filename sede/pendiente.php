...
<table class="table table-striped table-bordered" id="datatable-buttons">
             ...
             $sql = 'SELECT servicio,cartero,destino,numero_envio,destinatario,destino,fecha_entrada,DATEDIFF(sysdate(),fecha_entrada) AS Tiempo FROM customers WHERE cartero IS NOT NULL ';
