...
<title>INSTITUTO POSTAL DOMINICANO | SEDE</title>
...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="#" title='Programming Blog'>INSTITUTO POSTAL DOMINICANO | SEDE| Liquidar Piezas a Entregar</a>
        </div>
...
<?php
	$res = $MySQLiconn->query("SELECT id,numero_envio,servicio,fecha_entrada,peso_real,destino,destinatario,oficiales
FROM customers WHERE oficiales IS NOT NULL AND oficiales NOT IN ('seleccionar','Seleccionar...','') AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') <> DATE_FORMAT(SYSDATE(),'%Y/%m/%d')
AND  condicion_general = 2 AND servicio NOT IN ('ORDINARIO')  ORDER BY id DESC");
	$count = $res->num_rows;
