...
<form name="form1" >
 <?php $fecha1 = date('Y-m-d'); ?>
    <center> <h1> Reporte detallado de Piezas Entregadas por carteros </h1> </center>
<?php 
//QUERY COMBO 2
...
<meta charset="UTF-8">
  ...
  <style type="text/css" media="print"> 
    <title>Reporte detallado de Piezas Entregadas por carteros</title>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
           ...
           <table class="table table-bordered">
             ...
             $sql = "SELECT DISTINCT(numero_envio) AS tracking,servicio,time, destino,destinatario,fecha_entrada,DATEDIFF(time,fecha_entrada) AS Tiempo 
FROM despachado
WHERE  cartero IS NOT NULL and fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' AND cartero LIKE '%$ser5[1]%' and  cartero <> 'Seleccionar cartero' AND cartero <> ' ' ";
