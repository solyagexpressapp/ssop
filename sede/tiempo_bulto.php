...
<html lang="en">
  <head>
    ...
    <title>MONITORES | Tiempo de Entrega Bulto Postal</title>
...
<?php include 'header.php'; ?>
        ...
        <table class="table table-bordered" id="datatable-buttons">
             ...
             $sql = 'SELECT servicio, destino,numero_envio,destinatario,fecha_entrada,DATEDIFF(SYSDATE(),fecha_entrada) AS Tiempo,cartero FROM customers
             where condicion_general <> 4 AND cartero is not null and servicio = "BULTO POSTAL" AND oficiales IS NOT NULL AND oficiales NOT IN ("seleccionar","Seleccionar...","") order by tiempo desc;';
        ...
        50 => '#ff6666'
                  ...
                  echo '<td style="color: #000;">'. $row['destino'] . '</td>';
                  echo '<td style="color: #000;">'. $row['cartero'] . '</td>';
