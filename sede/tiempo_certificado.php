...
<html lang="en">
  <head>
    ...
    <title>MONITORES! | Tiempo de Entrega Certificado</title>
...
<?php include 'header.php'; ?>
        ...
        <table class="table table-bordered" id="datatable-buttons">
             ...
             where condicion_general <> 4 AND cartero is not null and servicio = "CERTIFICADO" AND oficiales IS NOT NULL AND oficiales NOT IN ("seleccionar","Seleccionar...","") order by tiempo desc;';
