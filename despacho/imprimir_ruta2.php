...
WHERE fecha_entrada = '$fecha'  AND colectora IS NOT NULL AND division_regional.nombre = 'CIUDAD' AND estafeta.ruta_postal  = 2
...
FROM narisol_bladi.customers
    ...
    INNER JOIN narisol_bladi.division_regional 
        ON (region.Id_division = division_regional.id_division) 
WHERE  fecha_entrada = '$fecha' AND colectora IS NULL AND division_regional.nombre = 'CIUDAD' AND estafeta.ruta_postal  = 2
ORDER BY estafeta";
