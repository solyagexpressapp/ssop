...
$q = $pdo->prepare($sql);
$q->execute(array('PRECINTOS',$destino,$descripcion,$presinto_servicio,$despacho_servicio));
Database::disconnect();
header("Location: precintos.php");
		}
	}
?>
<!DOCTYPE html>
...
<div class="container" id="izquierda">
    			...
    			<div class="span10 offset1">
    				<div class="row">
		    			<h3>Insertar Despacho de los Precintos</h3>
		    		</div>
    		<form class="form-horizontal" action="precintos.php" method="post">
	    				<!--Comienzo-->
					  <!--Primero-->
