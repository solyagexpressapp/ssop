...
$q = $pdo->prepare($sql);
$q->execute(array('SACA ALMACEN',$destino,$descripcion,$presinto_servicio,$despacho_servicio));
Database::disconnect();
header("Location: saca.php");
		}
	}
?>
<!DOCTYPE html>
...
<div class="container" id="izquierda">
    			...
    			<div class="span10 offset1">
    				<div class="row">
		    			<h3>Insertar Despacho de Saca de Almacen</h3>
		    		</div>
    		<form class="form-horizontal" action="saca.php" method="post">
	    				<!--Comienzo-->
					  <!--Primero-->
