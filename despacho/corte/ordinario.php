...
$q = $pdo->prepare($sql);
$q->execute(array('ORDINARIO',$destino,$descripcion,$presinto_servicio,$despacho_servicio));
Database::disconnect();
...
<div class="container" id="izquierda">
    			...
    			<div class="span10 offset1">
    				<div class="row">
		    			<h3>Insertar Despacho de Ordinario</h3>
		    		</div>
    		<form class="form-horizontal" action="ordinario.php" method="post">
	    				<!--Comienzo-->
					  <!--Primero-->
