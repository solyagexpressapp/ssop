...
$q = $pdo->prepare($sql);
$q->execute(array('TRANSITO',$destino,$descripcion,$presinto_servicio,$despacho_servicio));
Database::disconnect();
...
<div class="container" id="izquierda">
    			...
    			<div class="span10 offset1">
    				<div class="row">
		    			<h3>Insertar Despacho de los Transito</h3>
		    		</div>
    		<form class="form-horizontal" action="transito.php" method="post">
	    				<!--Comienzo-->
					  <!--Primero-->
