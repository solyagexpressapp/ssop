    ...
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTING CON COLECTORA<small></small></h2>
        ...
        <table class="table table-striped table-bordered" id="datatable-buttons">
             ...
             $sql = "SELECT fecha_entrada,
    servicio,COUNT(cantidad) as cantidad
    , estafeta.destino, customers.presinto_servicio    
FROM
    narisol_bladi.customers
    INNER JOIN narisol_bladi.estafeta 
        ON (customers.destino = estafeta.destino)
        WHERE estafeta.listin = 1  AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d') AND colectora IS NULL
        GROUP BY destino,presinto_servicio
