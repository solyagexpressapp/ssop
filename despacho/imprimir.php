...
FROM
    ...
    INNER JOIN narisol_bladi.ruta 
       ...
       WHERE CONDICION_GENERAL = 1 AND ruta.punto_ruta = '$destino1'  AND servicio <> 'COLIS POSTAL' AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d')
       GROUP BY destino,presinto_servicio,presinto_externo,servicio
