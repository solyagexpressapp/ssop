  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="glyphicon glyphicon-send"></i><span>LISTIN!</span></a>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt="">LISTIN
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTIN CON COLECTORA<small></small></h2>
        ...
        <input class="btn btn-default" type="button" value="Imprimir Todo" target="_blank" onClick=" window.location.href='imprimir_r_despacho.php'">
        <br/>
        <table class="table table-striped table-bordered" id="datatable-buttons">
             ...
             $sql = "SELECT id,servicio,presinto_servicio,despacho_general,COUNT(cantidad) AS cantidad,colectora,peso_real, estafeta.destino,fecha_entrada
    ...
    INNER JOIN narisol_bladi.division_regional 
        ...
        WHERE CONDICION_GENERAL = 1 AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d') GROUP BY presinto_servicio,destino,servicio ORDER BY id_estafeta";
                  ...
                  echo '<td width=250>';
                  echo '<a class="btn btn-success" href="reporte_despacho/update.php?id='.$row['id'].'">Editar</a>';
                  echo '</td>';
                  echo '</tr>';
             }
             Database::disconnect();
