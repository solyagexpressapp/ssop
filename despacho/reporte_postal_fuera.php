      ...
      <div class="main_container">
        ...
        <table class="table table-striped table-bordered" id="datatable-buttons">
             ...
             $sql = "SELECT servicio,fecha_entrada,
                    ...
                    , estafeta.destino, customers.colectora,presinto_servicio
                  FROM
                    narisol_bladi.customers
                  INNER JOIN narisol_bladi.estafeta 
                  ON (customers.destino = estafeta.destino)
                  WHERE estafeta.listin = 3 AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d') AND colectora IS NULL AND condicion_general = 1
