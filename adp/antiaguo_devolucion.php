...
$result = mysql_query("SELECT * from  customers WHERE servicio='CERTIFICADO' AND status= 1  AND porque IS NULL  ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Paquetes para Entregar <small></small></h2>
...
echo '<td width=250>';
echo '&nbsp;';
echo '<a class="btn btn-success" href="servicio_devolucion2/update.php?id='.$row['id'].'">Editar</a>';
echo '&nbsp;';
echo '</td>';
?>
</tr>
