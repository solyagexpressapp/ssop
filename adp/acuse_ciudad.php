...
<html lang="en">
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <button class="btn btn-success"><a href="imprimir_acuse_ciudad.php?numero_envio='<?php echo $row['numero_envio']?>'">Imprimir</a></button>
        <br/>
  ...
  $sql = "SELECT presinto_servicio,despacho_servicio,numero_envio,peso_real, estafeta.destino AS destino,fecha_entrada,pais_origen,destinatario, oficiales
FROM narisol_bladi.customers
    ...
    INNER JOIN narisol_bladi.division_regional 
        ...
        WHERE  servicio = 'CERTIFICADO' AND division_regional.nombre = 'CIUDAD' AND customers.destino <> 'CENTRO DE LOS HEROES' AND motivo is null AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d')
 ORDER BY id desc";
