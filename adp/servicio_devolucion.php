...
<html lang="en">
  <head>
    ...
    <title>Devoluciones! | Certificado</title>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <!----><p>
          <a href="certificado/create.php"></a>
        </p>
        <table id="datatable" class="table table-striped table-bordered">
             ...
             $sql = "SELECT * from  customers WHERE porque IS NOT NULL  AND servicio='CERTIFICADO' AND condicion_general = 1  ORDER BY id DESC";
