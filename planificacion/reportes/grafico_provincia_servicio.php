...
<?php 
//QUERY COMBO 2
$query="SELECT ID_REGION,nombre_region
from region
...
<html>
    <head>
        ...
        <title>Reporte de Provincial de las Piezas retenidas por Servicio</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Reporte Provincial de las Piezas retenidas por Servicio'
        },
        subtitle: {
            text: ''
        },
...
WHERE   region.nombre_region = '$ser5[1]' AND  fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "'          
     GROUP BY servicio
