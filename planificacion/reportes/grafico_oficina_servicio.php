...
<html>
	<head>
		...
		<title>REPORTE DE OFICINA POR SERVICIO RETENIDA</title>
...
$(function () {
    $('#container').highcharts({
        ...
        yAxis: {
            min: 0,
            title: {
                text: 'Rango de Piezas Retenidas'
            }
        },
        legend: {
            enabled: false
        ...
        tooltip: {
            pointFormat: 'Piezas Retenidas: <b>{point.y:.0f} Piezas</b>'
        },
        series: [{
            name: 'Piezas',
            data: [
    ...
    customers.servicio, COUNT(cantidad)
FROM
...
WHERE   estafeta.destino = '$ser5[1]' AND fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "'       
     GROUP BY servicio;
