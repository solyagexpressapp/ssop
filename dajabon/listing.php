...
WHERE DATE_FORMAT(fecha_entrada,'%Y/%m/%d') <> DATE_FORMAT(SYSDATE(),'%Y/%m/%d') AND fecha_entrada = '$fecha2' AND destino = 'DAJABON' ";
...
echo("<meta http-equiv=\"refresh\" content=\"0; url=dajabon.php\"/>");
