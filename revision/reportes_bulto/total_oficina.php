...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'REPORTE DE TOTAL DE PIEZAS ENTREGADAS POR OFICINA'
        },
        subtitle: {
            text: ''
        },
...
CONCAT('Cantidad') AS cantidad,COUNT(cantidad) AS Total 
FROM
despachado
WHERE destino = '$ser5[1]' AND TIME  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' AND servicio = 'BULTO POSTAL'");
