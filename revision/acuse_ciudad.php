...
FROM narisol_bladi.customers
    ...
    INNER JOIN narisol_bladi.division_regional 
        ...
        WHERE  servicio = 'CERTIFICADO' AND division_regional.nombre = 'CIUDAD'  AND customers.destino <> 'CENTRO DE LOS HEROES' AND impresion = 1 AND DATE_FORMAT(fecha_entrada,'%Y/%m/%d') = DATE_FORMAT(SYSDATE(),'%Y/%m/%d')
 ORDER BY destino";
