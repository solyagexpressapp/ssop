...
$result = mysqli_query($conn,"SELECT presinto_servicio,despacho_servicio,numero_envio,SUM(peso_real) as peso_real, estafeta.destino AS destino,fecha_entrada,pais_origen,destinatario
...
FROM narisol_bladi.customers
    ...
    INNER JOIN narisol_bladi.division_regional 
        ...
        ON (region.Id_division = division_regional.id_division) 
         ...
         WHERE  servicio = 'BULTO POSTAL'   AND fecha_entrada = '$fecha' AND (customers.destino LIKE '%$destino1%')
...
echo "<td align='center' colspan=2>BULTO POSTAL</td>";
