<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$q = $pdo->prepare($sql);
			$q->execute(array('BULTO POSTAL',$numero_envio,$destino,$destinatario,$direccion,$peso_real,$telefono,$descripcion,$despacho_servicio,$impresion,$monitores,$oficiales,$id));
			Database::disconnect();
			header("Location: ../bulto.php");
		}
	} else {
    ...
    <div class="container">
    			...
    			<div class="span10 offset1">
					...
					<!--Comienzo-->
					    ...
					    <div class="controls">
					      	<input name="servicio" type="text"  placeholder="servicio" disabled value="BULTO POSTAL">
