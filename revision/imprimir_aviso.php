...
$con = mysqli_connect("localhost","bmejia","bmejia","narisol_bladi");


header("Content-Type: text/html;charset=utf-8");

$result = mysqli_query($con,"SELECT destinatario,no_recibo,customers.direccion AS direccion, customers.telefono, servicio, fecha_entrada,estafeta.destino AS destino,estafeta.direccion AS direccion_estafeta,cantidad,peso_real,numero_envio,estafeta.telefono AS oftel,
