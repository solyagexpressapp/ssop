...
$conn = mysqli_connect("localhost","bmejia","bmejia","narisol_bladi");
...
$result = mysqli_query($conn,"SELECT presinto_servicio,despacho_servicio,numero_envio,peso_real, estafeta.destino AS destino,fecha_entrada,pais_origen,destinatario,monitores,oficiales
...
FROM narisol_bladi.customers
    ...
    INNER JOIN narisol_bladi.division_regional 
        ...
        WHERE  servicio = 'BULTO POSTAL'  AND fecha_entrada = '2018-07-27'  AND  (customers.destino LIKE '%$destino1%') AND  (customers.oficiales LIKE '%$oficial%')
...
echo "<td align='center'><span class='h'><strong>BULTO POSTAL</strong></span><span class='d'><strong>". $row['fecha_entrada'] ."</strong></span></td>";
