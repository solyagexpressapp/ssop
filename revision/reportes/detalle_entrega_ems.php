...
<form name="form1" >
 <?php $fecha1 = date('Y-m-d'); ?>
    <center> <h1> Reporte detallado de Piezas Entregadas por carteros de EMS </h1> </center>
<?php 
//QUERY COMBO 2
...
<meta charset="UTF-8">
  ...
  <style type="text/css" media="print"> 
    <title>Reporte detallado de Piezas Entregadas por carteros de EMS</title>
...
FROM despachado
WHERE condicion_general = 3  and fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' AND ems_carteros LIKE '%$ser5[1]%' and servicio = 'EMS' and ems_carteros <> 'Seleccionar cartero' and ems_carteros IS NOT NULL";
...
FROM devolucion
WHERE  fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' AND ems_carteros LIKE '%$ser5[1]%' and servicio = 'EMS' and ems_carteros <> 'Seleccionar cartero' and ems_carteros IS NOT NULL ";
