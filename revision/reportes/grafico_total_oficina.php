...
'Total',COUNT(DISTINCT(numero_envio)) AS Total 
FROM
despachado
WHERE destino = '$ser5[1]' AND fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' AND servicio IN ('COLIS POSTAL','EMS','BULTO POSTAL','CERTIFICADO')");
