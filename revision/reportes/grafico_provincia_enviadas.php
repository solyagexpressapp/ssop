...
<html>
	<head>
		...
		<title>Reporte de Piezas Entregadas por Administraciones Provinciales</title>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Reporte de Piezas Entregadas por Administraciones Provinciales'
        },
        subtitle: {
            text: ''
        },
   ...
   region.nombre_region
    , COUNT(DISTINCT(numero_envio)) AS cantidad
FROM
...
WHERE fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "' AND servicio IN ('CERTIFICADO','EMS','COLIS POSTAL','BULTO POSTAL') AND estafeta.destino <> 'CENTRO DE LOS HEROES'  
