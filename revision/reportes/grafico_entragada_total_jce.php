...
<html>
    <head>
        ...
        <title>Total de Piezas Entregadas por Servicio</title>
...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            data: [
               <?php
            $sql=mysql_query(" SELECT servicio,COUNT(DISTINCT(id)) 
              FROM despachado 
              WHERE servicio = 'JCE' AND fecha_entrada  BETWEEN  '" . $_GET["ser2"]. "' AND  '" . $_GET["ser3"]. "';");
