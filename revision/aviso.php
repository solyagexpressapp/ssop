...
<html lang="en">
  ...
  <head>
    ...
    <title>INSTITUTO POSTAL DOMINICANO! | REVISION </title>
...
<form action="imprimir_aviso.php?destino1='<?php echo $destino1 ;?>'&oficial='<?php echo $oficial ;?>'&fecha='<?php echo $fecha ;?>'" target="_blank">
...
<input type="date" name="fecha" value="<?php echo $date;?>">
