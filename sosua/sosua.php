...
<html lang="en">
  <head>
    ...
    <title>INSTITUTO POSTAL DOMINICANO! | SOSUA</title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTIN DE SOSUA DEL DIA <?php echo $fecha; ?> <small></small></h2>
...
FROM
    ...
    INNER JOIN narisol_bladi.division_regional 
       ...
       WHERE CONDICION_GENERAL = 1 AND customers.destino = 'SOSUA' AND fecha_entrada = '$fecha' AND alerta IS NULL
