...
<?php include 'header.php'; ?>
        ...
        <table class="table table-striped table-bordered" id="datatable-buttons">
             ...
             $sql = 'SELECT servicio, destino,numero_envio,destinatario,fecha_entrada,time AS liquidacion,DATEDIFF(time,fecha_entrada) AS Tiempo FROM despachado WHERE destino ="MONTE CRISTI"';
