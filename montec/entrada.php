...
include 'conexion.php';
	...
	$log = mysql_query("SELECT * FROM contabilidad WHERE nombre='$usuario' AND pass='$pw' AND servicio='MONTE CRISTI' ");
				if (mysql_num_rows($log)>0) {
					...
					echo '<script> window.location="monte_cristi.php"; </script>';
				}
				else{
