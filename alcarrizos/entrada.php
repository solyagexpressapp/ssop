...
include 'conexion.php';
	...
	$log = mysql_query("SELECT * FROM contabilidad WHERE nombre='$usuario' AND pass='$pw' AND servicio='LOS ALCARRIZOS' ");
				if (mysql_num_rows($log)>0) {
					...
					echo '<script> window.location="alcarrizos.php"; </script>';
				}
				else{
