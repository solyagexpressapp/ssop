          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>LISTIN DE ENS. LUPERON DEL DIA <?php echo $fecha; ?> <small></small></h2>
...
Seleccionar ENS. LUPERONcha: <input type="date" name="fecha"  onChange="this.form.submit()">
</form>
<br/> 
...
FROM
    ...
    INNER JOIN narisol_bladi.division_regional 
       ...
       WHERE CONDICION_GENERAL = 1 AND customers.destino = 'ENS. LUPERON' AND fecha_entrada = '$fecha' AND alerta IS NULL
